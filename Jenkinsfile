        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t 20it062/jay:${IMAGE_NAME} ."
      ...
      stage('deploy') {
        input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: '20it062', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    sh "echo ${PASSWORD} | docker login -u ${USERNAME} --password-stdin"
                    sh "docker push 20it062/jay:${IMAGE_NAME}"
                }}
